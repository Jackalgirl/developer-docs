...
- All scheduled coldkey swaps will be executed on-chain. **Your scheduled coldkey swap will execute on the mainnet in 7200 blocks (approximately 24 hours) after you successfully scheduled the coldkey swap using the method described in this document.**
